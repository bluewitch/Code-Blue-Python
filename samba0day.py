...
# With honour to the Hacking Godz whose shoulders I stand upon...
# For "dlab"
# ~dwulf
...
# Set do_brute, rs, FILTER variables
do_brute = True
rs = 1024
...
# Create connectback_shell() class Object
...
# Create ThreadedTCPServer() class Object
